export const ADMINENDPOINTS = {
  ...
  HOST_PORTAL_BOOKING_DETAIL: "/host/bookings/detail",
  HOST_PORTAL_BOOKINGS_EXPORT: "/host/bookings/export",
  HOST_PORTAL_EARNINGS: "/host/earnings/summary",
  HOST_PORTAL_PAYOUT_HISTORY: "/host/payout/history",
  HOST_PORTAL_PROFILE: "/host/profile",
  HOST_PORTAL_PROFILE_UPDATE: "/host/profile/update",
  HOST_PORTAL_PAYOUT_ACCOUNT_GET: "/host/payout-account/get",
  HOST_PORTAL_PAYOUT_ACCOUNT_UPDATE: "/host/payout-account/update",
  HOST_PORTAL_STATEMENTS_SEARCH: "/host/statements/search",
  HOST_PORTAL_STATEMENT_DOWNLOAD: "/host/statements/download",
  HOST_PORTAL_SUPPORT_TICKETS_SEARCH: "/host/support/tickets/search",
  HOST_PORTAL_SUPPORT_TICKETS_CREATE: "/host/support/tickets/create",
  HOST_PORTAL_SUPPORT_TICKETS_REPLY: "/host/support/tickets/reply",
  HOST_PORTAL_MESSAGES_LIST: "/host/messages/list",
  HOST_PORTAL_MESSAGES_SEND: "/host/messages/send",
  HOST_PORTAL_MESSAGES_MARK_READ: "/host/messages/mark-read",
  HOST_PORTAL_PERFORMANCE_SUMMARY: "/host/performance/summary",
};
