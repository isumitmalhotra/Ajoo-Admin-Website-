...
class NotificationRoutingService extends GetxService {
  ...
  void handleNotificationData(Map<String, dynamic> data) async {
    ...
    try {
      status = await authController.checkLoginStatus();
    } catch (e, stackTrace) {
    ...
    try {
      ...
      final property = Property(
        ...
        tags: propertyData.tags != null
            ? propertyData.tags!.map((e) => e.toString()).toList()
            : null,
        categories: propertyData.categories != null
            ? propertyData.categories!.map((e) => e.toString()).toList()
            : null,
        amenities: propertyData.amenities != null
            ? propertyData.amenities!.map((e) => e.toString()).toList()
            : null,
      );
      ...
      Get.toNamed('/negotiation', arguments: {
        ...
        'serverUrl': Apiconstants
            .serverUrl, //'https://api.aajoohomes.com', // Your server URL
