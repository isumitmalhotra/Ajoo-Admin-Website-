...
class NegotiationService {
  ...
  void joinNegotiationRoom(String userId, String propertyId, bool isHost) {
    if (_socket?.connected ?? false) {
      _socket!.emit('joinNegotiation',
          {'userId': userId, 'propertyId': propertyId, 'isHost': isHost});
      logger.i(
          'Joined negotiation room for user: $userId, property: $propertyId. is host: $isHost');
    } else {
