...
class _HotelCheckoutPageState extends State<HotelCheckoutPage> {
  ...
  Future<void> _submitReview() async {
    ...
    final url = 'https://api.aajoohomes.com/review/user/checkout';
    ...
    try {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: const Text('Review submitted successfully!')),
        );
        await showDialog(
          context: context,
          barrierDismissible: false,
  ...
  Widget build(BuildContext context) {
    ...
    // GST: Below ₹7500 => 5%, ₹7500 and above => 12%
    final gstRate = roomCharges < 7500 ? 0.05 : 0.12;
