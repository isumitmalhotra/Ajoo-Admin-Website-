          ...
          child: Column(
            ...
            children: [
              ...
              if (!isPrebooking)
                ...
                Row(
                  children: const [
                    Icon(Icons.lock_outline, color: Color(0xFFAD1457)),
                    SizedBox(width: 8),
                    Expanded(
                      child: Text(
  ...
  Widget _buildPriceChip(double price) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? const Color(0xFFAD1457) : Colors.grey[100],
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: isSelected ? const Color(0xFFAD1457) : Colors.grey[300]!,
            width: 1,
          ),
        ),
        child: Text(
