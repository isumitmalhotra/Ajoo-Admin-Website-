                        ...
                        children: [
                          ...
                          Obx(() {
                            ...
                            if (negotiationController.offerFinalized.value) {
                              ...
                              final isRenter =
                                  authController.userData.value?.isUser == true;
                              final gstRate = price < 7500 ? 0.05 : 0.12;
                                ...
                                label: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      negotiationController.acceptingOffer.value
                                          ? 'Accepting...'
                                          : 'Accept Offer ₹${latestForeignOffer.offerPrice?.toStringAsFixed(0) ?? ''}',
                                      style:
