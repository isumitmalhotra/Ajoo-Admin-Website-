...
> Tester build in circulation: **83 (1.0.0+83)**, `aajoo-homes-1.0.0-build83-release.apk` at repo root
> (2026-09-12, sha256 `a73d8b34…4ae080`, versionCode 83, 95.5 MB). **81 and 82 were withdrawn the
> same afternoon and their artifacts deleted** — 81 could not open some listings and 82 could not
> put them in a search result (§3.13, §3.16). All three superseded **49**, which the tester had had
> since 09-08 and which contains none of the 09-12 negotiation work.
> Read back with `python aajoo_app_2026/tool/verify_release_apk.py <apk> https://aajaodev.onrender.com
> --allow-test-payments --expect-version=1.0.0+83`: the endpoint it was given is in it, no other
