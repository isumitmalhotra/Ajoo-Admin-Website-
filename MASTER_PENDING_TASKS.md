...
> Tester build in circulation: **82 (1.0.0+82)**, `aajoo-homes-1.0.0-build82-release.apk` at repo root
> (2026-09-12, sha256 `788a7271…770491`, versionCode 82, 95.5 MB). **81 was withdrawn the same
> afternoon** — it carried the coordinate-parsing defect in §3.13, which made some listings
> impossible to open; if anyone is holding 81, replace it. Both superseded **49**, which the tester
> had had since 09-08 and which contains none of the 09-12 negotiation work.
> Read back with `python aajoo_app_2026/tool/verify_release_apk.py <apk> https://aajaodev.onrender.com
> --allow-test-payments --expect-version=1.0.0+82`: the endpoint it was given is in it, no other
