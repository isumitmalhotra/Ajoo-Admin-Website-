...
| ~~C18~~ | Cleaning fee | **Done 10 Sep; reversed by the client 15 Sep — STATED, not charged** (master list §1.14 / §8a31). The fee is carried on the quote and said under every total ("arranged and paid directly with the host, not included in this total") and under Things to know; it is in no total, no booking and no payout. Frequency optional, a courtesy to the guest. Builds 88–93 and the pre-15 Sep site still add it; the server recognises that figure and charges without it. |
