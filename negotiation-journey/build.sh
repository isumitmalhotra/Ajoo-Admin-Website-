...
set -e
cd "$(dirname "$0")/.."
PDF_SUBTITLE="Every scenario in the negotiation engine, photographed on the live site — what the guest sees and what the host sees, side by side." \
PDF_EYEBROW="Aajoo Homes &mdash; Negotiation engine" \
PDF_PREPARED="Prepared 9 September 2026 by the Zyphex Tech development team" \
PDF_VERIFIED="Every screen photographed on www.aajoohomes.com, driving the live flow" \
