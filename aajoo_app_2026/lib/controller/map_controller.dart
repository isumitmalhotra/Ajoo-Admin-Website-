...
import 'package:rent_home/screens/location_permission_denied.dart';
...
class MapController extends GetxController {
  ...
  Future<void> getProperties(
    ...
    // search is location-based, so a guest sitting anywhere we do not cover
    // yet — or an emulator still reporting Mountain View — gets an empty
    // result and an app that looks broken rather than merely far away.
    // Retry once, wide, exactly as the web client does.
