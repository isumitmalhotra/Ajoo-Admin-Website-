...
import 'package:rent_home/screens/checkout_page.dart';
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          // image
                          userController.property.value!.data!.images != null &&
                                  userController
                                      .property.value!.data!.images!.isNotEmpty
                              ? Image.network(
                                  userController
                                      .property.value!.data!.images![0],
                                  height: 200,
                                  width: double.infinity,
                                  fit: BoxFit.cover,
                                )
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Host Name: ${widget.booking.bookingPropertyHostDetailsUserFullName}\n',
                                    style: const TextStyle(
                                      fontSize: 18,
                              ...
                              IconButton(
                                  ...
                                  onPressed: () {
                                    DeviceService.launchDialPad(widget.booking
                                  ...
                                  child: ElevatedButton.icon(
                                    onPressed: () {
                                      DeviceService.launchWhatsapp(
                                        ...
                                        message:
                                            'Hello, I need assistance with my booking ID: ${widget.booking.bookId}',
                                      );
                                    },
                                    icon: Image.asset(
                                      "assets/whatsapp.png",
