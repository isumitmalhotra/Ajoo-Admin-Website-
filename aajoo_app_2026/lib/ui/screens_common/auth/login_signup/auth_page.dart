...
class _AuthPageState extends State<AuthPage> {
  ...
  /// Back out of the signup form to the login form, rather than out of the app.
  ///
  /// Login and signup are ONE screen toggled by [isLogin], so there is no route
  /// to pop when the signup form is showing — pressing Back left the app
  /// entirely, losing whatever had been typed. It reads as a crash. Handling
  /// the gesture here makes Back mean what the "Already have an account?" link
  /// means, and leaves the login form's own Back untouched.
  ...
  Widget build(BuildContext context) {
    return PopScope(
      // Only intercept while the signup form is up; on the login form Back
      // behaves normally and leaves the screen.
      canPop: isLogin,
                    ...
                    child: Column(
                      ...
                      children: [
                                        ...
                                        if (_formKey.currentState!.validate()) {
                                          if (isLogin) {
                                            ...
                                            if (authController
                                              ...
                                              authController.authConfirmPassword
                                                  .value = confirmVal;
                        ...
                        ...[
                          ...
                          Row(children: [
                            Expanded(
                                child: Divider(color: kMuted.withOpacity(.3))),
                            Padding(
                              padding:
