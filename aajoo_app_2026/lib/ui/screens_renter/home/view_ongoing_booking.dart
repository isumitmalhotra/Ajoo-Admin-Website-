                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  ...
                                  // while a failed fetch left the PREVIOUS
                                  // listing in the slot -- so the crash it
                                  // avoided was replaced by checking out
                                  // against the wrong stay. The controller now
                                  // empties the slot on failure, and this says
                                  // so rather than throwing.
                                  final pd =
                                      userController.property.value?.data;
                                  if (pd == null) {
                                    Get.snackbar(
                                      'Booking',
                                      "We couldn't load this stay. Please try again.",
