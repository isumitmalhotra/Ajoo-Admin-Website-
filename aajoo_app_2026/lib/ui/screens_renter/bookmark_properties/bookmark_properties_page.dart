...
class _BookmarkedPropertiesPageState extends State<BookmarkedPropertiesPage> {
  ...
  Future<void> _removeBookmark(int propertyId) async {
    await _bookmarkService.removeBookmark(propertyId);
    await _loadBookmarks(); // Refresh the list
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Property removed from bookmarks')),
    );
  }
                        ...
                        MaterialPageRoute(
                          builder: (context) => PropertyPage(
                            property: Property(
                              ...
                              categoryTitles: property.categoryTitles,
                            ),
