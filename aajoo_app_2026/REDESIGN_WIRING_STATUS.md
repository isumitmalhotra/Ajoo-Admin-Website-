...
| H-5 | Add Property | `screens_host/add_property/host_property_listing_screen.dart` | 🟡 | Center-FAB flow. 1191-line multi-step wizard w/ image + KYC-doc upload — kept functional; teal via P0 + re-tinted the one off-palette blue info callout. Full scaffold-style redesign deferred (high-risk rewrite). |
